...
const IconPedaki = (props: IconProps) => (
    <svg role="img" viewBox="0 0 691 691" fill="none" {...props}>
        <rect x="1.5" y="1.5" width="688" height="688" rx="158.5" fill="url(#paint0_radial_30_22)" stroke="black" strokeWidth="3"/>
        ...
        <defs>
            <filter id="filter0_d_30_22" x="91.9668" y="42" width="573.391" height="605.322" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
